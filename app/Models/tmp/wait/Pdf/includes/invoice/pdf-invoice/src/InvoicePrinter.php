...
class InvoicePrinter extends FPDF
{
    ...
    public $columnSpacing   = 0.4;                /* Spacing between Item Tables */
    ...
    public function setHeader($name,$value){
        ...
        $this->headerField []= array("name"=>$name,"value"=>$value);
    ...
    public function Header()
    {
        ...
        foreach($this->headerField as $val){
            $positionX = 90;
            //Number
                $this->Cell($positionX, $lineheight);
                $this->SetTextColor($this->color[0], $this->color[1], $this->color[2]);
                $this->Cell(32, $lineheight, iconv("UTF-8", "ISO-8859-1", mb_strtoupper($val["name"], 'UTF-8') . ':'), 0, 0,
                    'L');
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, '', 9);
                $this->Cell(0, $lineheight, $val["value"], 0, 1, 'R');
    ...
    public function Body()
    {
        ...
        if ($this->badge) {
            ...
            $this->setTextColor($this->color[0], $this->color[1], $this->color[2]);
            $this->SetFont($this->font, 'b', 10);
           // $this->Rotate(0, $this->getX(), $this->getY());
            $this->Rect($this->GetX(), $this->GetY(), $this->GetStringWidth($badge) + 0, 10);
